--[[
        ...
        ╚═╝░░╚═╝╚══════╝╚═════╝░╚═╝░░╚═╝░╚════╝░░░░╚═╝░░░╚══════╝╚═╝╚═════╝░
	Source:
        https://raw.githubusercontent.com/iHavoc101/Genesis-Studios/main/UserInterface/redactlib.lua
...
if _G.redactlib_Loaded and _G.redactlib then
    _G.redactlib:Destroy()
end

-- Set Globals --
_G.redactlib_Loaded = true
_G.redactlib = nil
...
_G.redactlib = redactlib.ScreenGui
for i,v in pairs({Name = "Template", Debug = false}) do
    if redactlib.Settings[i] == nil then
        redactlib.Settings[i] = v
    end
end

-- Intro --
function redactlib.LoadingScreen()
    coroutine.wrap(function()
        local LoadingScreen = Utility.new("Frame", {
            Name = "LoadingScreen",
            Parent = redactlib.ScreenGui,
        ...
        Utility.Wait(2.5)
        Services.ContentProvider:PreloadAsync({redactlib.ScreenGui})
        Utility.Wait(0.25)
...
local function CreateOptions(Frame)
    ...
    function Options.Button(Title, ButtonText, Callback)
        ...
        Container.Button.MouseButton1Down:Connect(function()
            ...
            assert(redactlib.Settings.Debug == false or Success, Error)
        end)
    ...
    function Options.Switch(Title, Callback)
        ...
        local Tweens = {
            [true] = {
                Utility.Tween(Container.Switch, TweenInfo.new(0.5), {BackgroundColor3 = redactlib.ColorScheme.Primary}),
        ...
        local Container = Utility.new("ImageButton", {
            ...
            Utility.new("ImageLabel", {
                ...
                Utility.new("ImageLabel", {
                    ...
                    Image = "rbxassetid://5028857472",
                    ImageColor3 = redactlib.ColorScheme.Primary,
                    ScaleType = Enum.ScaleType.Slice,
                    SliceCenter = Rect.new(2, 2, 298, 298)
                }, {
                    Utility.new("Frame", {
...
function redactlib.new(Name, Header, Icon)
            ...
            Utility.new("ImageLabel", {
                ...
                Utility.new("Frame", {
                    ...
                    Utility.new("TextLabel", {
                        ...
                        Text = Name and tostring(Name) or "redactlib",
                        TextColor3 = Color3.fromRGB(255, 255, 255),
                        TextScaled = true,
                        TextWrapped = true,
                        TextXAlignment = Enum.TextXAlignment.Left
    ...
    -- Window --
    local Window = {
        Title = Name and tostring(Name) or "redactlib";
    ...
    function Window.Tab(Title, Icon)
        ...
        local TabButton = Utility.new("Frame", {
            Name = "Button",
            Parent = Main.SideBar,
            BackgroundColor3 = redactlib.ColorScheme.Primary,
            BackgroundTransparency = 1,
            BorderSizePixel = 0,
        ...
        function Tab.Folder(Title, Description)
            ...
            local Tweens = {
                [true] = {
                    ...
                    Utility.Tween(Base.Title, TweenInfo.new(0.5), {TextTransparency = 0, TextColor3 = redactlib.ColorScheme.Primary}),
                    Utility.Tween(Base.Icon, TweenInfo.new(0.5), {ImageTransparency = 0, ImageColor3 = redactlib.ColorScheme.Primary}),
                };
                [false] = {
                    function()
                        Utility.Wait(0.1)
        ...
        function Tab.Cheat(Title, Description, Callback)
            ...
            local SwitchTweens = {
                [true] = {
                    Utility.Tween(Base.Switch, TweenInfo.new(0.5), {BackgroundColor3 = redactlib.ColorScheme.Primary}),
    ...
    return setmetatable(Window, {__newindex = function(Self, Index, Value)
        if Index == "Title" then
            Main.SideBar.Info.Title.Text = Value and tostring(Value) or "redactlib"
